# data/sounding_stations.py
# Static list of NWS upper-air (radiosonde) stations within the MBTiles coverage
# bbox: lon -116° to -82°, lat 28° to 49°.
#
# Covers: MT, WY, ID, UT, CO, NM, AZ, ND, SD, NE, KS, OK, TX, MN, IA, MO,
#         AR, LA, WI, IL, MI (west), IN, OH (west), KY, TN, MS, AL, GA (west)
#
# Elevations are approximate (m MSL) and used only for map display — actual
# surface elevation comes from the IEM sounding response itself.
